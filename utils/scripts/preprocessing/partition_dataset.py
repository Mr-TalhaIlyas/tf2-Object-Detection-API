...
# Example:
# 1st cd t where the script is located
#      python partition_dataset.py --imageDir=C:\Users\Talha\Desktop\API_2\raw_data 
#      --outputDir=C:\Users\Talha\Desktop\API_2\models\workspace\data --ratio=0.2 --xml
